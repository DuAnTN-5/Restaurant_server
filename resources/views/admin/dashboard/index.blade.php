...
<div class="wrapper wrapper-content">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-lg-9">
                            <canvas id="ordersRevenueChart" width="400" height="150"></canvas> <!-- Canvas chứa biểu đồ -->
                        </div>
                        <div class="col-lg-3">
                            <ul class="stat-list">
                                <li>
    ...
    <div class="row">
        <!-- Cột hiển thị Top 10 sản phẩm bán chạy -->
        <div class="ibox float-e-margins col-lg-4">
            <div class="ibox-title">
            ...
            <div class="ibox-content">
                <div class="tab-content">
                    ...
                    <div id="day" class="tab-pane fade in active">
                        <h3 class="text-danger">Top 10 sản phẩm bán chạy trong ngày</h3>
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach($topProductsDay as $product)
                                    <tr>
                                        <td>{{ $product->name }}</td>
                    ...
                    <div id="week" class="tab-pane fade">
                        <h3 class="text-danger">Top 10 sản phẩm bán chạy trong tuần</h3>
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Tên</th>
                    ...
                    <div id="month" class="tab-pane fade">
                        <h3 class="text-danger">Top 10 sản phẩm bán chạy trong tháng</h3>
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Tên</th>
                            ...
                            <tbody>
                                @foreach($topProductsMonth as $product)
                                    <tr>
                                        <td>{{ $product->name }}</td>
                                        <td>{{ $product->quantity }}</td>
                                    </tr>
                    ...
                    <div id="year" class="tab-pane fade">
                        <h3 class="text-danger">Top 10 sản phẩm bán chạy trong năm</h3>
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Tên</th>
                            ...
                            <tbody>
                                @foreach($topProductsYear as $product)
                                    <tr>
                                        <td>{{ $product->name }}</td>
                                        <td>{{ $product->quantity }}</td>
                                    </tr>
        ...
        <!-- Cột hiển thị Danh sách mã giảm giá -->
        <div class="ibox float-e-margins col-lg-4">
            <div class="ibox-title">
