<div class="row">
    <div class="col-lg-12 text-right">
        <form method="GET" action="{{ route('product-categories.index') }}" class="form-inline">
            ...
            <!-- Nút Thêm Danh Mục -->
            <a href="{{ route('product-categories.create') }}" class="btn btn-danger mb-2 ml-2">Tạo Mới Danh Mục</a>
        </form>
    </div>
</div>
